...
const AdminLogin = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      console.log("Attempting admin login with payload:", { email: values.email, password: values.password });
      const response = await api.post("/admin-login", { email: values.email, password: values.password });
      console.log("Admin login response:", response);
      
      if (response.data && response.data.token) {
        console.log("Admin access token received:", response.data.token);
